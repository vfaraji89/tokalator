...
what I miss in website, privacy, etc-- first audit
...
delete all nexjs favicons and use only abacus favicon in all screens

### Prompt 41

do we have updated content on website-- check where we have missing part

### Prompt 42

what do you think for claude code
