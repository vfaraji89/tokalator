...
export function generateStaticParams() {
  const items = getCatalogByKind('instruction');
...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    title: item ? item.name : "Instruction",
    description: item?.description || "Instruction detail page",
  };
}
