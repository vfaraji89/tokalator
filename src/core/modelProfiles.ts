...
export const MODEL_PROFILES: ModelProfile[] = [
  // Anthropic
  { id: 'claude-opus-4-5'      , label: 'Claude Opus 4.5'      , provider: 'anthropic'  , contextWindow:  200000, maxOutput:  32000, rotThreshold: 40 },
  ...
  { id: 'gpt-4.1-mini'         , label: 'GPT-4.1 Mini'         , provider: 'openai'     , contextWindow: 1047576, maxOutput:  32768, rotThreshold: 15 },
  { id: 'gpt-4.1-nano'         , label: 'GPT-4.1 Nano'         , provider: 'openai'     , contextWindow: 1047576, maxOutput:  32768, rotThreshold: 12 },
  ...
  { id: 'gemini-2.5-flash-lite', label: 'Gemini 2.5 Flash Lite', provider: 'google'     , contextWindow: 1048576, maxOutput:  65536, rotThreshold: 20 },
];
